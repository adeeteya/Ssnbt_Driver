...
Stop chengalpettuOldBS = Stop(
    "ChengalpettuOldBS", const TimeOfDay(hour: 6, minute: 20), 12.696916, 79.976698);
Stop chengalpettuNewBS = Stop("ChengalpettuNewBS",
    const TimeOfDay(hour: 6, minute: 21), 12.691019302869828, 79.98064489854454);
Stop rattinakinaru = Stop("Rattinakinaru", const TimeOfDay(hour: 6, minute: 23),
    12.68431959799922, 79.98350149738138);
Stop thirukazhukundram = Stop("Thirukazhukundram",
    const TimeOfDay(hour: 6, minute: 40), 12.608888692587445, 80.05640569267044);
Stop thiruporur =
...
Stop venusGandhiStatue = Stop("VenusGandhiStatue",
    const TimeOfDay(hour: 6, minute: 07), 13.112768938045688, 80.23772445816371);
...
//Route 4
Stop porurKumarSweets = Stop("PorurKumarSweets",
    const TimeOfDay(hour: 6, minute: 15), 13.034830281045663, 80.15620977694533);
Stop shellPB = Stop("ShellPB", const TimeOfDay(hour: 6, minute: 20),
    13.031728591859972, 80.16455999956432);
Stop mugalaivakkamBS =
    Stop("MugalaivakkamBS", const TimeOfDay(hour: 6, minute: 22), 13.0202, 80.1663);
Stop ramapuramBS =
...
Stop santhomeChurch5 =
    Stop("SanthomeChurch", const TimeOfDay(hour: 6, minute: 35), 13.0336, 80.2778);
...
Stop mylaporeTank5 =
    Stop("MylaporeTank", const TimeOfDay(hour: 6, minute: 45), 13.0340, 80.2679);
...
Stop santhomeChurch6 =
    Stop("SanthomeChurch", const TimeOfDay(hour: 6, minute: 35), 13.0336, 80.2778);
Stop fshoreEstate =
    Stop("FShoreEstate", const TimeOfDay(hour: 6, minute: 40), 13.032835, 80.279613);
Stop mrcNagar =
    Stop("MRCNagar", const TimeOfDay(hour: 6, minute: 41), 12.968251, 80.261055);
...
Stop ambatturEstate7 = Stop(
    "AmbatturEstate", const TimeOfDay(hour: 6, minute: 07), 13.089208, 80.161308);
Stop wavin7 =
    Stop("Wavin", const TimeOfDay(hour: 6, minute: 10), 13.088531, 80.171981);

//Route 8

Stop p1PoliceStationPulianthope =
    Stop("GoldenFlatsBS", const TimeOfDay(hour: 6, minute: 05), 13.100000, 80.259911);
Stop natarajaTheatre = Stop(
    "NatarajaTheatre", const TimeOfDay(hour: 6, minute: 20), 13.092807, 80.269475);
Stop choolaiPO =
    Stop("ChoolaiPO", const TimeOfDay(hour: 6, minute: 25), 13.090429, 80.265557);
Stop chindadripetRamadaHotel = Stop("ChindadripetRamadaHotel",
    const TimeOfDay(hour: 6, minute: 30), 13.0770319, 80.2648825);
Stop sathyamTheatre = Stop(
    "SathyamTheatre", const TimeOfDay(hour: 6, minute: 35), 13.055702, 80.258107);
Stop royapettah = Stop("Royapettah", const TimeOfDay(hour: 6, minute: 40),
    13.047944435155072, 80.25998896672377);
Stop gopalapuramGround = Stop(
    "GopalapuramGround", const TimeOfDay(hour: 6, minute: 42), 13.052277, 80.257048);
Stop royapettahTTKRoad = Stop("RoyapettahTTKRoad",
    const TimeOfDay(hour: 6, minute: 43), 13.046592788205022, 80.26031171128115);
Stop alwarpet = Stop("Alwarpet", const TimeOfDay(hour: 6, minute: 44),
    13.035746942591922, 80.25469784011696);
Stop rtoOffice =
    Stop("RTOOffice", const TimeOfDay(hour: 6, minute: 59), 13.029794, 80.264403);
Stop chennaiNeelankarai = Stop(
    "ChennaiNeelankarai", const TimeOfDay(hour: 7, minute: 05), 12.954222, 80.254879);
Stop periaNeelankarai = Stop(
    "PeriaNeelankarai", const TimeOfDay(hour: 7, minute: 07), 12.95050494, 80.255177);

//Route 9

Stop tskNagar = Stop("TSKNagar", const TimeOfDay(hour: 6, minute: 00),
    13.178945030451084, 80.29671695634441);
Stop collectorNagar = Stop("CollectorNagar",
    const TimeOfDay(hour: 6, minute: 03), 13.087890093063299, 80.18885342650677);
...
Stop goldmineHotel =
    Stop("GoldmineHotel", const TimeOfDay(hour: 6, minute: 17), 13.071929, 803202913);
...
Stop tirunagar =
    Stop("Tirunagar", const TimeOfDay(hour: 6, minute: 26), 13.057578, 80.211360);
Stop kasiTheatre =
    Stop("KasiTheatre", const TimeOfDay(hour: 6, minute: 32), 13.029526, 80.208473);
Stop ekattuthangal =
    Stop("Ekattuthangal", const TimeOfDay(hour: 6, minute: 35), 13.022679, 80.202165);

//Route 11

Stop peramburMarket =
    Stop("PeramburMarket", const TimeOfDay(hour: 6, minute: 00), 13.113117, 80.23610);
Stop peramburRS =
    Stop("PeramburRS", const TimeOfDay(hour: 6, minute: 06), 13.107998, 80.244748);
Stop peramburBS =
    Stop("PeramburBS", const TimeOfDay(hour: 6, minute: 06), 13.108621, 80.248012);
Stop pattalamBS =
    Stop("PattalamBS", const TimeOfDay(hour: 6, minute: 11), 13.096836, 80.259234);
...
Stop gangadeeswaranKoil = Stop(
    "GangadeeswaranKoil", const TimeOfDay(hour: 6, minute: 18), 13.083707, 80.254515);
Stop dhasprakash =
    Stop("Dhasprakash", const TimeOfDay(hour: 6, minute: 22), 13.078714, 80.253465);
Stop egmore =
...
Stop annaArivalayam11 = Stop(
    "AnnaArivalayam", const TimeOfDay(hour: 6, minute: 31), 13.042041, 80.248077);

//Route 12

Stop villivakkam =
    Stop("Villivakkam", const TimeOfDay(hour: 6, minute: 05), 13.105436, 80.208025);
Stop icf =
    Stop("ICF", const TimeOfDay(hour: 6, minute: 10), 13.095104, 80.216130);
Stop iynavaramRlyQtrs = Stop(
    "IynavaramRlyQtrs", const TimeOfDay(hour: 6, minute: 12), 13.100498, 80.226127);
Stop jointOffice =
    Stop("JointOffice", const TimeOfDay(hour: 6, minute: 15), 13.102135, 80.230352);
Stop sayani =
    Stop("Sayani", const TimeOfDay(hour: 6, minute: 18), 13.098057, 80.238813);
Stop secretriateColony = Stop(
    "SecretriateColony", const TimeOfDay(hour: 6, minute: 21), 13.089325, 80.243092);
Stop kellys =
    Stop("Kellys", const TimeOfDay(hour: 6, minute: 22), 13.085626, 80.244360);
Stop kilpaukGarden =
    Stop("KilpaukGarden", const TimeOfDay(hour: 6, minute: 25), 13.083258, 80.232157);
...
Stop pachiapasSignal = Stop("pachiapasSignal",
    const TimeOfDay(hour: 6, minute: 28), 13.079458768154788, 80.23375645204014);
...
Stop arumbakkamBS =
    Stop("ArumbakkamBS", const TimeOfDay(hour: 6, minute: 15), 13.065225, 80.211282);
Stop panjaliammanKoil = Stop(
    "PanjaliammanKoil", const TimeOfDay(hour: 6, minute: 16), 13.071843, 80.210147);
Stop annaArch =
    Stop("AnnaArch", const TimeOfDay(hour: 6, minute: 20), 13.075249, 80.217922);
Stop nelsonManickamRoad = Stop(
    "NelsonManickamRoad", const TimeOfDay(hour: 6, minute: 22), 13.069046, 80.225390);
Stop methaNagar =
    Stop("MethaNagar", const TimeOfDay(hour: 6, minute: 25), 13.067656, 80226730);
Stop choolaimedu =
    Stop("Choolaimedu", const TimeOfDay(hour: 6, minute: 26), 13.063219, 80.224903);
Stop pushpaNagar =
    Stop("PushpaNagar", const TimeOfDay(hour: 6, minute: 28), 13.05837, 80.240697);
Stop valluvarkottam = Stop(
    "Valluvarkottam", const TimeOfDay(hour: 6, minute: 30), 13.054502, 80.241791);
Stop tNagarTPRoad =
    Stop("TNagarTPRoad", const TimeOfDay(hour: 6, minute: 35), 13.048706, 80.240107);
Stop vanimahal =
    Stop("Vanimahal", const TimeOfDay(hour: 6, minute: 36), 13.044625, 80.240167);
Stop drNairRoad =
    Stop("DrNairRoad", const TimeOfDay(hour: 6, minute: 37), 13.042770, 80.240844);
Stop tNagarPH = Stop("TNagarPH", const TimeOfDay(hour: 6, minute: 38),
    13.053369140841555, 80.22480572019509);
Stop kasiArcade =
    Stop("KasiArcade", const TimeOfDay(hour: 6, minute: 39), 13.040281, 80.244226);
Stop cenetaphRoad =
    Stop("CenetaphRoad", const TimeOfDay(hour: 6, minute: 42), 13.032107, 80.245812);

//Route 15

Stop chinmayaNagar =
    Stop("ChinmayaNagar", const TimeOfDay(hour: 6, minute: 15), 13.063069, 80.197178);
Stop natesanNagar =
    Stop("NatesanNagar", const TimeOfDay(hour: 6, minute: 16), 13.057527, 80.194077);
Stop elangoNagar =
    Stop("ElangoNagar", const TimeOfDay(hour: 6, minute: 25), 13.054148, 80.192463);
Stop avichiSchool =
    Stop("AvichiSchool", const TimeOfDay(hour: 6, minute: 28), 13.048746, 80.197632);
Stop ramTheatre =
    Stop("RamTheatre", const TimeOfDay(hour: 6, minute: 35), 13.051310, 80.216796);
Stop liberty15 = Stop("Liberty", const TimeOfDay(hour: 6, minute: 38),
    13.053020329732187, 80.22793652835465);
Stop kodambakkamBridge = Stop(
    "KodambakkamBridge", const TimeOfDay(hour: 6, minute: 39), 13.053973, 80.234573);
Stop venkatnarayanaRoad = Stop(
    "VenkatnarayanaRoad", const TimeOfDay(hour: 6, minute: 41), 13.035901, 80.236721);
//Route 16

Stop pThangalSubway = Stop(
    "PThangalSubway", const TimeOfDay(hour: 6, minute: 40), 12.988655, 80.185892);
Stop chidambaramStore = Stop(
    "ChidambaramStore", const TimeOfDay(hour: 6, minute: 43), 12.985959, 80.195377);
Stop vanuvampetChurch = Stop(
    "VanuvampetChurch", const TimeOfDay(hour: 6, minute: 45), 12.982743, 80.195230);
Stop ulagaram =
    Stop("Ulagaram", const TimeOfDay(hour: 6, minute: 46), 11.966979, 79.202642);
Stop badalavinayagarTemple = Stop("BadalavinayagarTemple",
    const TimeOfDay(hour: 6, minute: 47), 12.971148, 80.190601);
Stop madipakkamMegaMart = Stop(
    "MadipakkamMegaMart", const TimeOfDay(hour: 6, minute: 49), 12.963318, 80.187771);
Stop kovilambakkam =
    Stop("Kovilambakkam", const TimeOfDay(hour: 7, minute: 04), 12.938830, 80.182336);
Stop vellakal =
    Stop("Vellakal", const TimeOfDay(hour: 7, minute: 06), 12.985999, 80.231326);
Stop medavakkamKootRoad = Stop(
    "MedavakkamKootRoad", const TimeOfDay(hour: 7, minute: 10), 12.919641, 80.182284);

//Route 17

Stop ramTheatre2 =
    Stop("RamTheatre", const TimeOfDay(hour: 6, minute: 25), 13.053598, 80.215222);
Stop liberty17 = Stop("Liberty", const TimeOfDay(hour: 6, minute: 30),
    13.053020329732187, 80.22793652835465);
Stop powerHouse =
    Stop("PowerHouse", const TimeOfDay(hour: 6, minute: 38), 13.047006, 80.216988);
Stop periyarRoad =
    Stop("periyarRoad", const TimeOfDay(hour: 6, minute: 40), 13.038478, 80.248851);
Stop northUsmanRoad = Stop(
    "NorthUsmanRoad", const TimeOfDay(hour: 6, minute: 42), 13.044198, 80.232310);
Stop tNagarBS17 =
    Stop("tNagarBS", const TimeOfDay(hour: 6, minute: 44), 13.033995, 80.229845);
Stop citNagar17 =
    Stop("CITNagar", const TimeOfDay(hour: 6, minute: 45), 13.030473, 80.230758);
Stop saidapet17 = Stop("Saidapet", const TimeOfDay(hour: 6, minute: 50),
    13.014765973822504, 80.22601701911348);
Stop saidapetCourt17 =
    Stop("SaidapetCourt", const TimeOfDay(hour: 6, minute: 52), 13.013360, 80.226886);
Stop madhyakailash17 =
    Stop("Madhyakailash", const TimeOfDay(hour: 6, minute: 57), 13.018047, 80.257920);

//Route 18

Stop korattur =
    Stop("Korattur", const TimeOfDay(hour: 6, minute: 10), 13.111633, 80.184238);
Stop postOffice = Stop("PostOffice", const TimeOfDay(hour: 6, minute: 11),
    13.114542843146669, 80.1852994747567);
Stop annanagarWDepot = Stop(
    "AnnanagarWDepot", const TimeOfDay(hour: 6, minute: 14), 13.093804, 80.198496);
Stop blueStar =
    Stop("BlueStar", const TimeOfDay(hour: 6, minute: 18), 13.082728, 80.210361);
Stop nerkundram =
    Stop("Nerkundram", const TimeOfDay(hour: 6, minute: 20), 13.267865, 80.185346);

//Route 19

Stop valasaravakkam = Stop(
    "Valasaravakkam", const TimeOfDay(hour: 6, minute: 15), 13.040584, 80.172077);
Stop kesavarthini =
    Stop("Kesavarthini", const TimeOfDay(hour: 6, minute: 17), 13039198, 80177599);
Stop alwarthirunagar = Stop(
    "Alwarthirunagar", const TimeOfDay(hour: 6, minute: 19), 13.044333, 80.184900);
Stop virugambakkam =
    Stop("Virugambakkam", const TimeOfDay(hour: 6, minute: 22), 13.046395, 80.190125);
Stop kkNagarPondyGH = Stop("KKNagarPondyGH",
    const TimeOfDay(hour: 6, minute: 24), 13.041964124197769, 80.19333754184821);
Stop ammanKoil = Stop("AmmanKoil", const TimeOfDay(hour: 6, minute: 27),
    13.00603471351879, 80.20660361116433);
Stop kkNagarRoundana = Stop(
    "KKNagarRoundana", const TimeOfDay(hour: 6, minute: 28), 13.040731, 80.191687);
Stop ashokPillar19 =
    Stop("AshokPillar", const TimeOfDay(hour: 6, minute: 29), 13.033604, 80.212082);

//Route 20

Stop chindadripet =
    Stop("Chindadripet", const TimeOfDay(hour: 6, minute: 30), 13.074947, 80.271422);
Stop egmore2 =
...
Stop royapettahHospital = Stop(
    "RoyapettahHospital", const TimeOfDay(hour: 6, minute: 41), 13.055390, 80.264878);
Stop policeStation =
    Stop("PoliceStation", const TimeOfDay(hour: 6, minute: 42), 13.051932, 80.263962);
Stop ajantha =
    Stop("Ajantha", const TimeOfDay(hour: 6, minute: 44), 13.047029, 80.266463);
Stop valluvarstatue = Stop(
    "Valluvarstatue", const TimeOfDay(hour: 6, minute: 47), 13.041234, 80.268257);
Stop luzCorner20 =
    Stop("LUZCorner", const TimeOfDay(hour: 6, minute: 48), 13.036427, 80.268262);
Stop mylaporeTank20 =
    Stop("MylaporeTank", const TimeOfDay(hour: 6, minute: 49), 13.033143, 80.268555);

//Route 21

Stop avichiSchool2 =
    Stop("AvichiSchool", const TimeOfDay(hour: 6, minute: 20), 13.048830, 80.19641);
Stop sooriyaHospital = Stop(
    "SooriyaHospital", const TimeOfDay(hour: 6, minute: 23), 12.989737, 80.267459);
Stop vadapalaniDepot = Stop(
    "VadapalaniDepot", const TimeOfDay(hour: 6, minute: 27), 13.050552, 80.206829);
Stop vadapalaniSignal = Stop(
    "VadapalaniSignal", const TimeOfDay(hour: 6, minute: 30), 13.050221, 80.212000);
Stop ashokNagarCanaraBank = Stop("AshokNagarCanaraBank",
    const TimeOfDay(hour: 6, minute: 31), 13.040042, 80.212522);
Stop ashokNagar =
    Stop("AshokNagar", const TimeOfDay(hour: 6, minute: 37), 13.035680, 80.211120);
Stop srinivasaTheatre = Stop(
    "SrinivasaTheatre", const TimeOfDay(hour: 6, minute: 41), 13.031071, 80.224911);
Stop aranganathanSubway21 = Stop(
    "AranganathanSubway", const TimeOfDay(hour: 6, minute: 43), 13.028276, 80.225416);
Stop citNagar21 =
    Stop("CITNagar", const TimeOfDay(hour: 6, minute: 47), 13.030092, 80.230854);
Stop saidapetCourt21 =
    Stop("SaidapetCourt", const TimeOfDay(hour: 6, minute: 48), 13.013360, 80.226886);
Stop annaUniversity = Stop(
    "AnnaUniversity", const TimeOfDay(hour: 6, minute: 49), 13.0101888, 80.235378);
Stop madhyakailash21 =
    Stop("Madhyakailash", const TimeOfDay(hour: 6, minute: 50), 13.018047, 80.257920);

//Route 22

Stop psbbSchool =
    Stop("PSBBSchool", const TimeOfDay(hour: 6, minute: 20), 13.040030, 80.199490);
Stop doubleTank =
    Stop("Doubletank", const TimeOfDay(hour: 6, minute: 23), 13.041701, 80.203404);
Stop kkNagarDepot =
    Stop("KKNagarDepot", const TimeOfDay(hour: 6, minute: 25), 13.034368, 80.205586);
Stop esiHospital =
    Stop("ESIHospital", const TimeOfDay(hour: 6, minute: 27), 13.034873, 80.207369);
Stop ashokPillar22 =
    Stop("AshokPillar", const TimeOfDay(hour: 6, minute: 28), 13.035273, 80.210875);
Stop govindanRoad =
    Stop("GovindanRoad", const TimeOfDay(hour: 6, minute: 34), 12.958815, 80.251751);
Stop mettupalayam =
    Stop("Mettupalayam", const TimeOfDay(hour: 6, minute: 35), 13.177272, 80.074706);
Stop srinivasaTheatre2 = Stop(
    "SrinivasaTheatre", const TimeOfDay(hour: 6, minute: 36), 13.031071, 80.224911);
Stop aranganathanSubway22 = Stop(
    "AranganathanSubway", const TimeOfDay(hour: 6, minute: 37), 13.028276, 80.225416);
Stop citNagar22 =
    Stop("CITNagar", const TimeOfDay(hour: 6, minute: 38), 13.030092, 80.230854);
Stop saidapetCourt22 =
    Stop("SaidapetCourt", const TimeOfDay(hour: 6, minute: 41), 13.013360, 80.226886);
Stop madhyakailash22 =
    Stop("Madhyakailash", const TimeOfDay(hour: 6, minute: 45), 13.018047, 80.257920);

//Route 23

Stop jeyarajTheatre = Stop("JeyarajTheatre",
    const TimeOfDay(hour: 6, minute: 25), 13.024924858282283, 80.2165241838512);
Stop govtBoysschool = Stop("GovtBoysschool",
    const TimeOfDay(hour: 6, minute: 27), 13.025867598954523, 80.21957828417713);
...
Stop ayothyaMandapam = Stop("AyothyaMandapam",
    const TimeOfDay(hour: 6, minute: 38), 13.039309682656834, 80.22099795501546);
Stop panigrahalyanamandapam = Stop("PanigrahKalyanamandapam",
    const TimeOfDay(hour: 6, minute: 40), 13.042683332010485, 80.22210335483872);
...
Stop venkatanarayanaRoad = Stop("VenkatanarayanaRoad",
    const TimeOfDay(hour: 6, minute: 45), 13.037049189077731, 80.23609668182338);
...
Stop libertyMeenakshiCollege = Stop("LibertyMeenakshiCollege",
    const TimeOfDay(hour: 6, minute: 30), 13.054025969917227, 80.22742421327686);
Stop periyarRoadBBC = Stop("PeriyarRoadBBC",
    const TimeOfDay(hour: 6, minute: 40), 13.057357309445042, 80.23652163927814);
Stop bharathiNagarNUR = Stop("BharathiNagarNUR",
    const TimeOfDay(hour: 6, minute: 41), 12.985390177368144, 80.23516488671228);
...
Stop saidapetCourt24 = Stop("SaidapetCourt",
    const TimeOfDay(hour: 6, minute: 50), 13.017842923922085, 80.22647795752876);
Stop indiraNagarRlySt = Stop("IndiraNagarRlySt",
    const TimeOfDay(hour: 6, minute: 56), 12.998441206712466, 80.24913724781995);

//Route 25

Stop chepaukStadium = Stop("ChepaukStadium",
    const TimeOfDay(hour: 6, minute: 25), 13.062540927129241, 80.28033589136702);
...
Stop kalyaniHospital = Stop("KalyaniHospital",
    const TimeOfDay(hour: 6, minute: 38), 13.043712507405008, 80.27200066883552);
Stop sanskritCollege = Stop("SanskritCollege",
    const TimeOfDay(hour: 6, minute: 40), 13.040502351122297, 80.26848149716695);
...
Stop tiruvanmiyurPO25 = Stop("TiruvanmiyurPO",
    const TimeOfDay(hour: 6, minute: 55), 12.987444810991281, 80.25910799996485);

//Route 26

Stop rangarajapuramVBank = Stop("RangarajapuramVBank",
    const TimeOfDay(hour: 6, minute: 20), 13.047197539396592, 80.22526442650644);
...
Stop duraisamyRoad26 = Stop("DuraisamyRoad", const TimeOfDay(hour: 6, minute: 25),
    13.046172080976458, 80.21459716833112);
Stop venkatanarayanaRoad26 = Stop("VenkatanarayanaRoad",
    const TimeOfDay(hour: 6, minute: 28), 13.036164565588116, 80.23676299767087);
Stop ttd26 = Stop("TTD", const TimeOfDay(hour: 6, minute: 30), 13.03594641892866,
    80.23640242600278);
...
Stop mgrJanakiCollege = Stop("MGRJanakiCollege",
    const TimeOfDay(hour: 6, minute: 47), 13.016564551637192, 80.26077413128927);
Stop adyarDepot = Stop("adyarDepot", const TimeOfDay(hour: 6, minute: 48),
    12.998596704171462, 80.25609586092574);
Stop tiruvanmiyurPO27 = Stop("TiruvanmiyurPO",
    const TimeOfDay(hour: 6, minute: 55), 12.983544991036679, 80.25495528182276);

//Route 28

Stop kalpakkam = Stop("Kalpakkam", const TimeOfDay(hour: 6, minute: 30),
    12.50248596095174, 80.15383303948921);
Stop babaTempleFountainStop = Stop("BabaTempleFountainStop",
    const TimeOfDay(hour: 6, minute: 35), 12.517354084292798, 80.16046775533725);
...
Stop krishnaNagarBS = Stop("KrishnaNagarBS",
    const TimeOfDay(hour: 6, minute: 35), 12.915367965967214, 80.10244262496758);
...
Stop ega = Stop("EGA", const TimeOfDay(hour: 6, minute: 30), 13.07788109074099,
    80.24055885719034);
Stop chetputSignal30A = Stop("ChetputSignal", const TimeOfDay(hour: 6, minute: 31),
    13.070641011505304, 80.24185562216181);
Stop shastriBhavan = Stop("ShastriBhavan", const TimeOfDay(hour: 6, minute: 34),
    13.067700687415972, 80.24798301534399);
Stop sterlingRoadJnGemini = Stop("SterlingRoadJnGemini",
    const TimeOfDay(hour: 6, minute: 36), 13.067087310452997, 80.24319063946132);
Stop annaArivalayam30A = Stop("AnnaArivalayam",
    const TimeOfDay(hour: 6, minute: 38), 13.043428275202578, 80.24814881534398);
...
Stop uti = Stop("UTI", const TimeOfDay(hour: 6, minute: 47), 12.966252462283746,
    80.1886547265057);
Stop keelkattalaiBS = Stop("KeelkattalaiBS",
    const TimeOfDay(hour: 6, minute: 49), 12.969364798723765, 80.18944263730971);
...
Stop sanitoriumGKHotel = Stop("SanitoriumGKHotel",
    const TimeOfDay(hour: 6, minute: 44), 12.958668756020096, 80.14569961721322);
...
Stop rajendraStores = Stop("Rajendrastores",
    const TimeOfDay(hour: 6, minute: 41), 12.970642926344746, 80.19049642946744);
Stop utiBank = Stop("UTIBank", const TimeOfDay(hour: 6, minute: 42),
    12.966252462283746, 80.1886547265057);
Stop ponniammanKoil = Stop("PonniammanKoil",
    const TimeOfDay(hour: 6, minute: 44), 12.968454987795582, 80.19621432620191);
...
Stop srinivasaNagar = Stop("Srinivasanagar",
    const TimeOfDay(hour: 6, minute: 49), 12.964954577137059, 80.21109554606113);
Stop okkiam = Stop("Okkiam", const TimeOfDay(hour: 6, minute: 52),
    12.950318557465074, 80.23453298417651);

//Route 34

Stop adambakkamPKoil = Stop("AdambakkamPKoil",
    const TimeOfDay(hour: 6, minute: 35), 12.993016478005549, 80.20329389767056);
...
Stop aavinoppMalarH = Stop("AavinoppMalarH",
    const TimeOfDay(hour: 6, minute: 40), 13.012869164021856, 80.24756455018584);
Stop avvaiHome = Stop(
    "AvvaiHome", const TimeOfDay(hour: 6, minute: 41), 13.00855538942582, 80.2622965);
...
Stop jayanthiTheatreThiruvanmiyur = Stop("JayanthiTheatreThiruvanmiyur",
    const TimeOfDay(hour: 6, minute: 50), 12.989897604439104, 80.25601020000119);
Stop thiruvanmiyurTMBBank = Stop("ThiruvanmiyurTMBBank",
    const TimeOfDay(hour: 7, minute: 04), 12.988190935742521, 80.25949704232798);
Stop vettuvankaniChurch = Stop("VettuvankaniChurch",
    const TimeOfDay(hour: 7, minute: 10), 12.940513932732674, 80.25308656931199);
Stop sholinganallurJnECR = Stop("SholinganallurJnECR",
    const TimeOfDay(hour: 7, minute: 14), 12.901194225085057, 80.22786391127984);
...
Stop perungalathur36 = Stop("Perungalathur", const TimeOfDay(hour: 6, minute: 50),
    13.196443755674666, 79.64901204011836);

//Route 37

Stop ambikkaAppalam = Stop("AmbikkaAppalam",
    const TimeOfDay(hour: 6, minute: 45), 13.007239332850343, 80.25153716150119);
...
Stop palavakkamAntonyChurch = Stop("PalavakkamAntonyChurch",
    const TimeOfDay(hour: 6, minute: 56), 12.958958219738694, 80.25709435396801);
Stop neelankaraiBuhariHotel = Stop("NeelankaraiBuhariHotel",
    const TimeOfDay(hour: 6, minute: 57), 12.942900888261622, 80.25345461534401);
Stop echambakkamBusStop = Stop("EchambakkamBusstop",
    const TimeOfDay(hour: 7, minute: 00), 12.919725494136324, 80.25105383068801);
Stop uthandiTollGate = Stop("UthandiTollGate",
    const TimeOfDay(hour: 7, minute: 12), 12.862680082565952, 80.24176053862399);
Stop kannathur = Stop("AmbikkaAppalam", const TimeOfDay(hour: 7, minute: 13),
    12.85262321321878, 80.24134296247158);

//Route 38

Stop jayanthiTheatre = Stop("JayanthiTheatre",
    const TimeOfDay(hour: 6, minute: 40), 12.989772153025056, 80.25596728465601);
...
Stop navallurCognizant = Stop("NavallurCognizant-",
    const TimeOfDay(hour: 7, minute: 23), 12.825734768724983, 80.21975526869035);
...
Stop hindustanCollege = Stop("HindustanCollege",
    const TimeOfDay(hour: 7, minute: 29), 12.802505921890962, 80.22405418465598);
...
Stop gurunanakCollege = Stop("Gurunanak College",
    const TimeOfDay(hour: 6, minute: 42), 12.993774239210568, 80.22185348465601);
...
Stop taramaniChurch = Stop("TaramaniChurch",
    const TimeOfDay(hour: 6, minute: 58), 12.982324652107152, 80.24207756486814);
Stop kalyanamandapam = Stop("Kalyanamandapam",
    const TimeOfDay(hour: 7, minute: 00), 12.983730845370948, 80.20805922650584);
...
Stop velachery100RoadSangeethaHotel = Stop(
...
Stop eastTambaramUCOBank = Stop("EastTambaramUCOBank",
    const TimeOfDay(hour: 6, minute: 40), 12.924244335228883, 80.12797893068799);
...
Stop coromandelFlats = Stop("CoromandelFlats",
    const TimeOfDay(hour: 6, minute: 47), 12.923657321690085, 80.13265908386123);
Stop campRoad = Stop("CampRoad", const TimeOfDay(hour: 6, minute: 52),
    12.92260840441804, 80.14155412482067);
Stop mahalakshmiNagar = Stop("MahalakshmiNagar",
    const TimeOfDay(hour: 6, minute: 55), 12.922932132797738, 80.14726072667462);
...
Stop medavakkamKootRoad41 = Stop("MedavakkamKootRoad",
    const TimeOfDay(hour: 7, minute: 02), 12.919835959933392, 80.18209585864913);
...
Stop singaperumalKoil = Stop("SingaperumalKoil",
    const TimeOfDay(hour: 6, minute: 35), 12.761520411427929, 80.00320840106758);
...
Stop eb = Stop("EB", const TimeOfDay(hour: 6, minute: 52), 12.851147864573711,
    80.06510718051116);
Stop urapakkmTeakadai = Stop("UrapakkmTeakadai",
    const TimeOfDay(hour: 6, minute: 53), 12.862181348724958, 80.07325299716493);
Stop urapakkamSchool = Stop("UrapakkamSchool",
    const TimeOfDay(hour: 6, minute: 55), 12.866328888223682, 80.07527483949326);
